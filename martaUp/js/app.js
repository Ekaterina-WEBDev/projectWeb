 ...
 */
    ...
    (() => {
        ...
        document.querySelector(".header__inputs");
        document.addEventListener("click", (event => {
            if (event.target.closest(".header__btn")) {
                btns.forEach((btn => {
                    btn.classList.remove("header__btn--active");
                }));
                event.target.classList.add("header__btn--active");
            } else event.target.classList.remove("header__btn--active");
            if (event.target.closest(".header__link")) {
                links.forEach((link => {
                    link.classList.remove("header__link--active");
                }));
                event.target.classList.add("header__link--active");
            } else event.target.classList.remove("header__link--active");
        }));
    })();
})();